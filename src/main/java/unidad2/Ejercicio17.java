...
//		int cpu = random.nextInt(n - 1 + 1) + 1;
		
//		System.out.printf("He pensado un número entre 1 y %d, adivina cuál es:", cpu);
//		int jugador;
//		do {
...
//		System.out.println("Has acertado!");
		...
		int cpu = random.nextInt(random.nextInt(99001) + 1000) + 1;
